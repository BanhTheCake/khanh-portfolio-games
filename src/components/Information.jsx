              ...
              <div className=" flex flex-col gap-5 px-10">
                <div className="flex flex-col gap-3 pb-2">
                  ...
                  <div className="flex border-2 p-3 rounded-xl border-white/80">
                    <p className="font-poppins">Hi, Im Khánh, 23 years old Illustrator living in Da Nang city.
                ...
                <div className="flex flex-col gap-3 pb-2">
                  ...
                  <div className="flex flex-col border-2 p-3 rounded-xl border-white/80">
                    <p className="font-poppins">- Graduated from DaNang Architecture University as Designer</p>
                    <p className="font-poppins">- Intern at Koei Tecmo software DaNang</p>
                    <p className="font-poppins">- Intern at Hue Monuments Conservation Centre</p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="flex flex-col border-2 p-3 rounded-xl border-white/80">
                    <div className="flex items-center gap-1">
                     <img className="w-12" src={PsIcon} alt="AE" />
                      <p className="font-poppins">: I use Photoshop most, for drawing brush</p>
                    </div>
                    <div className="flex items-center gap-1">
                     <img className="w-12" src={AiIcon} alt="AE" />
                      <p className="font-poppins">: I use Illustration for create arts need high quality to print</p>
                    </div>
                    <div className="flex items-center gap-1">
                     <img className="w-12" src={AeIcon} alt="AE" />
                      <p className="font-poppins">: I use After Effect for create motion art, visual led</p>
                    </div>
                  </div>
                </div>
